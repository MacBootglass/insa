...
% paramètres du problème primal
c = [3 1]';
b = [1 1 1 1]';
A = [1 1; 1 -1;-1 1;-1 -1];

% Tracé de la fonction objectif et des contraintes du problème primal
N = 150;
x = linspace(-2, 5, N);
y = linspace(-2, 5, N);
[X,Y] = meshgrid(x, y);
...
cvx_begin quiet % quiet pour éviter l'affichage des iterations de cvx
