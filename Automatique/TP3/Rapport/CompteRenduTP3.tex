...
\begin{document}
	...
	\section{Étude du système mécanique}
		...
		\subsection{Étude pratique}
			\begin{center}
				\includegraphics[width=12cm]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Images/Figure1.pdf}
			\end{center}
			\begin{itemize}
	...
	\section{Réglage de la rapidité}
		...
		\subsection{Étude pratique: réponse de l'enregistreur asservi}
			\begin{center}
				\includegraphics[width=12cm]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Images/Figure2.pdf}
			\end{center}
			\begin{itemize}
			...
			\begin{center}
				\includegraphics[width=12cm]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Images/Figure3.pdf}
			\end{center}
			\begin{itemize}
	...
	\section{Réglage du dépassement}
		...
		\subsection{Étude pratique}
			\begin{center}
				\includegraphics[width=12cm]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Images/Figure4.pdf}
			\end{center}
			\begin{center}
				\includegraphics[width=12cm]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Images/Figure5.pdf}
			\end{center}
			\begin{itemize}
			...
			\begin{center}
				\includegraphics[width=12cm]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Images/Figure6.pdf}
			\end{center}


	\section{Code Scilab}
		\begin{center}
			\includepdf[page=1]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Code.pdf}
			\includepdf[page=2]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Code.pdf}
			\includepdf[page=3]{/home/ttheologien/MEGAsync/ASI_3.2/Automatique/TP3/Code.pdf}
		\end{center}
\end{document}
